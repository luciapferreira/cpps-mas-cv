...
public class Constants {
    ...
    public static final String RELEASE_OCCUPANCY = "RELEASE_OCCUPANCY";
    public static final String RELEASE_RESERVE = "RELEASE_RESERVE";
    public static final String RESERVE_RESOURCE = "RESERVE_RESOURCE";
    public static final String SELECT_RESOURCE = "SELECT_RESOURCE";
